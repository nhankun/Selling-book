...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active text-dark" aria-current="page">danh sách đơn hàng cần xuất kho ({{$donhangs->count()}})</li>
        </ol>
    </nav>
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <form action="{{route('donhang.xuathang',$dh->MaDH)}}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn btn-outline-primary" onclick="return confirm('Bạn đã sẵn sàng xuất hàng?');"><i class="fas fa-dolly-flatbed"></i>Xuất hàng</button>
                                </form>
